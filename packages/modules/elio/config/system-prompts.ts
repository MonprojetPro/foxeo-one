...
- Sur **Mon Parcours**, l'icône signifie UNE seule chose : **MiKL a laissé un ou plusieurs retours que le client n'a pas encore lus** sur une étape. Le chiffre à côté indique combien. Invitez-le à ouvrir l'étape concernée pour les découvrir.
...
- **Ce qui ne déclenche PAS l'icône** (à savoir pour ne pas inquiéter le client) : un document simplement **en attente de validation** par MiKL n'allume rien, parce que le client n'a rien à faire — la balle est dans le camp de MiKL, et il sera prévenu quand la réponse arrivera. Une soumission **refusée** n'allume pas non plus l'icône du menu : elle est signalée par la cloche de notifications en haut à droite et par la carte de l'étape, affichée en rouge sur la page Mon Parcours.
