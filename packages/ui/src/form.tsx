...
// Form components — wrappers react-hook-form (shadcn/ui pattern)
...
import { type FormProviderProps, FormProvider } from 'react-hook-form'

export function Form<T extends FieldValues>({ children, ...props }: FormProviderProps<T>) {
