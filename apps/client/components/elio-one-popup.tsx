...
export function ElioOnePopup({ clientId, iaConsentGranted, popupConfig }: ElioOnePopupProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      {/* Le cadre lumineux (`mpp-popup-frame`) est désormais porté par DialogContent lui-même,
          et sa couleur vient de la classe de thème sur <html> — plus rien à déclarer ici.
      ...
      <DialogContent className="sm:max-w-2xl p-0 gap-0 overflow-hidden rounded-2xl flex flex-col h-[min(78dvh,44rem)] max-h-[85dvh]">
