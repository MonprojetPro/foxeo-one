// API Route: /api/exports/[exportId]/download (app cliente)
// Story: 9.5a — Export RGPD des données client
//
// Miroir de apps/hub. Indispensable côté client : la notification d'export
// pointe vers un chemin RELATIF, donc le client (authentifié sur l'app cliente)
// télécharge depuis SON domaine — pas le Hub, où il n'a aucune session.
//
