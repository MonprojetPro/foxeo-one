...
| T-023 | Voir les 2 captures de Lucie dans le cockpit | NON VERIFIE PAR MOI — l'ecran est derriere une session operateur. C'est la seule chose qui reste, et elle revient a MiKL | non verifie |
...
| Ouvrir le fil de Lucie dans le cockpit et confirmer que ses 2 captures s'affichent : c'est la derniere verification, et elle demande une session operateur — je ne peux pas la faire a la place de MiKL. Le deploiement, lui, est fait et reussi (15-09) | MiKL | T-023 | 2026-09-15 |
