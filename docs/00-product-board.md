...
| T-018 | SPF de monprojet-pro.com obsolete (OVH) — n'autorise pas Resend, ne correspond plus au MX reel (Google) | Dette technique | MiKL 2026-09-01 (signalement sans email recu) | Must | Interne | H | S | Qualifie — DNS chez MiKL | — | 2026-09-01 | — | 2026-09-01 |
...
| Corriger le SPF de monprojet-pro.com (`v=spf1 include:mx.ovh.com -all` — n'autorise ni Resend ni Google, alors que le MX reel est `smtp.google.com`) : ajouter l'include Resend, retirer la reference OVH obsolete | MiKL | T-018 | 2026-09-01 |
